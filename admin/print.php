	...
	<body>
							...
							<table class="table table-hover table-bordered">
							  ...
							  <?php
									$no = 1;
									$total_semua = 0;
									$sqlquery = $sqlquery = 'SELECT keuangan.no_invoice, tanggal_transaksi, qty,discount,total, pelanggan.no_polisi, tipe_motor, alamat, sparepart.no_sparepart, nama_sparepart, harga_sparepart, service.jenis_service from pelanggan join service on pelanggan.no_polisi=service.no_polisi join sparepart on service.yss_code=sparepart.yss_code join keuangan on sparepart.no_sparepart=keuangan.no_sparepart';
